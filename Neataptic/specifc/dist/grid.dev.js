...
for (var index = 0; index < tests; index++) {
  ...
  for (var _ss = 0; _ss < 4; _ss++) {
    var _element = array[_ss];
    eval("var _16_" + _ss + " = []");
  ...
  for (var _ss2 = 0; _ss2 < 8; _ss2++) {
    var _element2 = array[_ss2];
    eval("var _8_" + _ss2 + " = []");
  ...
  for (var _ss3 = 0; _ss3 < 16; _ss3++) {
    var _element3 = array[_ss3];
    eval("var _4_" + _ss3 + " = []");
  ...
  for (var _ss4 = 0; _ss4 < 32; _ss4++) {
    var _element4 = array[_ss4];
    eval("var _2_" + _ss4 + " = []");
  ...
  for (var _ss5 = 0; _ss5 < 64; _ss5++) {
    var _element5 = array[_ss5];
    eval("var _1_" + _ss5 + " = []");
  ...
  for (var _i = 0; _i < 10; _i++) {
    for (var _j = 0; _j < 59; _j++) {
      next = _j + 1; // console.log("loop"+i+"["+j+"].connect(loop"+i+"["+next+"]);")

      eval("loop" + _i + "[" + _j + "].connect(loop" + _i + "[" + next + "]);");
    }
  }

  for (var _i2 = 0; _i2 < 10; _i2++) {
    for (var _j2 = 0; _j2 < 59; _j2++) {
      next = _i2 + 1; // console.log("loop"+i+"["+j+"].connect(loop"+i+"["+next+"]);")

      eval("loop" + _i2 + "[" + _j2 + "].connect(loop" + next + "[" + _j2 + "]);");
    }
  }

  for (var i = 0; i < output.length; i++) {
    for (var j = 0; j < 10; j++) {
      eval("loop" + j + "[59].connect(output[" + i + "]);");
    }
  }
  ...
  for (var _i3 = 0; _i3 < 1000; _i3++) {
    if (g(Dataset[9000 + _i3]["output"]) != g(softmax(network.activate(Dataset[9000 + _i3]["input"])))) {
      errors = errors + 1;
    }
  }
  ...
  for (var _i4 = 0; _i4 < 2000; _i4++) {
    if (g(Dataset[10000 + _i4]["output"]) != g(softmax(network.activate(Dataset[10000 + _i4]["input"])))) {
      errors = errors + 1;
    }
  }
