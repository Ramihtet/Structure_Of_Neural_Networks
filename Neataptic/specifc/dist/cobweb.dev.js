...
for (var index = 0; index < tests; index++) {
  ...
  for (var i = 0; i < input.length; i++) {
    for (var j = 0; j < 20; j++) {
      input[i].connect(loop1[j]);
    }
  }

  for (var i = 0; i < 10; i++) {
    for (var j = 0; j < output.length; j++) {
      loop1[19 - i].connect(output[j]);
    }
  } // for (var i = 0; i < input.length; i++) {
  //     for (var j = 0; j <10; j++){
  //         input[i].connect(loop2[j]);
  //     } 
  // }
  ...
  for (var i = 0; i < 10; i++) {
    for (var j = 0; j < output.length; j++) {
      loop2[19 - i].connect(output[j]);
    }
  } // for (var i = 0; i < input.length; i++) {
  //     for (var j = 0; j <10; j++){
  //         input[i].connect(loop3[j]);
  //     } 
  // }
  ...
  for (var i = 0; i < 10; i++) {
    for (var j = 0; j < output.length; j++) {
      loop3[19 - i].connect(output[j]);
    }
  }

  for (var i = 0; i < loop1.length; i++) {
    loop1[i].connect(loop2[i]);
  }

  for (var i = 0; i < loop1.length; i++) {
    loop2[i].connect(loop3[i]);
  }

  for (var i = 0; i < loop3.length; i++) {
    for (var j = 0; j < core.length; j++) {
      loop3[i].connect(core[j]);
    }
  }

  for (var i = 0; i < core.length; i++) {
    for (var j = 0; j < output.length; j++) {
      core[i].connect(output[j]);
    }
  }
