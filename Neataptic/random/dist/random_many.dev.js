...
var datas = [];
var all_graphs = obj[0]["data"]; // all_graphs= all_graphs.splice(5,100)

for (var graph_i = 1; graph_i < all_graphs.length; graph_i++) {
  try {
    ...
    for (var index = 0; index < tests; index++) {
      ...
      for (var _i2 = 0; _i2 < edges.length; _i2++) {
        nodess[edges[_i2][0]].connect(nodess[edges[_i2][1]]);
      }
      ...
      var network = n.architect.Construct(nodess); // var network = n.architect.Construct(nodess);
      /////////////////////////////////////////////////////////////////
      //Training
    ...
    var xls = tool.json2xls(datas, {
      order: ["ID", "Rate", "Momentum", "Batchsize", "Rate_policy", "Dropout", "Activation", "av_short", "av_cluster", "num_edges", "input_connections", "output_connections", "Accuracy", "EDGES"]
